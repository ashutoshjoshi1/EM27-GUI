...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        temp_card = QGroupBox()
        temp_card.setFixedSize(180, 240)
        ...
        pres_card = QGroupBox()
        pres_card.setFixedSize(180, 240)
